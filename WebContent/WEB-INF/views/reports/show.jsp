			...
			<c:when test="${report != null}">
				...
				<table>
					<tbody>
						...
						<tr>
							<th>いいね数</th>
							<td class="report_like"><a href="<c:url value='/likes/index?id=${report.id}' />">${report.like_count}</a></td>
					</tbody>
				</table>
				...
				<c:if test="${sessionScope.login_employee.id != report.employee.id && report.like_count == 0}">

					<p>
						<a href="<c:url value="/reports/like_count?id=${report.id}" />">この日報にいいねする</a>
					</p>
				</c:if>
